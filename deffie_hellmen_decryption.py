...
def deff_hell_dec():
    ...
    label0 = Label(frame, text="Deffie-Hellmen Algorithm for Decryption", bg="#D0ECE7", font=("Tahoma", 20, "bold"))
    label0.pack(padx=10)
    ...
    ct = Label(frame, text="Enter Cipher Text for decryption:", bg="#D0ECE7", font=("Tahoma", 16, "normal"))
    ct.pack(padx=10)
    ct.place(x=10, y=210)

    ct_e = Entry(frame, width=27, font=("Tahoma", 16, "normal"))
    ct_e.pack()
    ct_e.place(x=340, y=213)

    pt = Label(frame, text="Plain Text after decryption:", bg="#D0ECE7", font=("Tahoma", 16, "normal"))
    pt.pack(padx=10)
    pt.place(x=10, y=250)

    pt_e = Entry(frame, width=27, font=("Tahoma", 16, "normal"))
    pt_e.pack()
    pt_e.place(x=340, y=253)

    myButton1 = Button(frame, text="Decrypt", font=("calibri", 15,'bold'), bg='#A3E4D7', width=8, command=prime)
